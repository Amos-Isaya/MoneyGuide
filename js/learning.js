  ...
  function dashboard() {
    ...
    main.innerHTML = `
      ...
      <section id="practice" class="dashboard-section practice-section" aria-labelledby="practice-title"><div class="section-heading"><div><p class="eyebrow">${t('featurePractice')}</p><h2 id="practice-title">${t('practiceIntro')}</h2></div></div>
        ...
        <article class="practice-card"><div class="premium-card-top">${MoneyGuideCards.icon('coach')}<span class="card-index">02</span></div><h3>${t('learnGaming')}</h3><p>${t('gamingCard')}</p><a class="text-link" href="games.html">${t('learnGaming')} →</a></article></div>
      </section>
