...
const MoneyGuideShell = (() => {
  ...
  const navItems = [['home','navHome','index.html'],['about','navAbout','index.html#about'],['modules','featureLearn','dashboard.html#modules'],['practice','featurePractice','dashboard.html#practice'],['tools','navTools','dashboard.html#tools'],['progress','featureProgress','dashboard.html#progress'],['certificates','featureCertificates','dashboard.html#certificates']];
