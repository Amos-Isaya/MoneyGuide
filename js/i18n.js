...
const MoneyGuideI18n = (() => {
  const words = {
    heroEyebrow: ['YOUR FUTURE STARTS WITH UNDERSTANDING','TU FUTURO EMPIEZA CON EL CONOCIMIENTO','VOTRE AVENIR COMMENCE PAR LA COMPRÉHENSION'],
    heroLineOne: ['Make sense of money.','Comprende tu dinero.','Comprenez votre argent.'],
    heroLineTwo: ['Make room for life.','Abre espacio para vivir.','Faites place à la vie.'],
    heroDescription: ['Build the knowledge to navigate your first paycheck, your next semester, and everything that comes after.','Aprende a gestionar tu primer sueldo, tu próximo semestre y todo lo que viene después.','Apprenez à gérer votre premier salaire, votre prochain semestre et tout ce qui suivra.'],
    ...
    featureEyebrow: ['YOUR NEXT CHAPTER','TU PRÓXIMO CAPÍTULO','VOTRE PROCHAIN CHAPITRE'],
    featureHeading: ['Everything you need to build financial confidence.','Todo para ganar confianza financiera.','Tout pour construire votre confiance financière.'],
    featureIntro: ['Knowledge. Practice. Perspective. Choose your next step.','Conocimiento. Práctica. Perspectiva. Elige tu próximo paso.','Savoir. Pratique. Perspective. Choisissez votre prochaine étape.'],
    ...
    featureCoachText: ['Personalized explanations powered by NVIDIA Nemotron are planned for a future release.','Las explicaciones personalizadas con NVIDIA Nemotron están previstas para una versión futura.','Des explications personnalisées avec NVIDIA Nemotron sont prévues dans une future version.'],
    ...
    coachPreview: ['The AI Learning Coach is coming soon. NVIDIA Nemotron has not been integrated yet. Your lessons, practice, and progress are available today.','El tutor con IA estará disponible más adelante. NVIDIA Nemotron aún no está integrado. Ya puedes usar las lecciones, la práctica y el progreso.','Le coach IA sera disponible ultérieurement. NVIDIA Nemotron n’est pas encore intégré. Les leçons, la pratique et la progression sont déjà disponibles.'],
